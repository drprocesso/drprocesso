...
export default function Home() {
  ...
  const handleEarlySubmit = (e: React.FormEvent) => {
    ...
    handleFormSubmit(
      ...
      () => {
        setEarlyFormData({ cpf: '', email: '', whatsapp: '', consent: false });
        setEarlyFormErrors({ cpf: false, email: false, whatsapp: false });
      }
    );
  };
  ...
  const handleOfferSubmit = (e: React.FormEvent) => {
    ...
    handleFormSubmit(
      ...
      () => {
        setOfferFormData({ cpf: '', email: '', whatsapp: '', consent: false });
        setOfferFormErrors({ cpf: false, email: false, whatsapp: false });
      }
    );
  };
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <LazyImage 
                  src="/dr_processo_logo_rodape.webp" 
                  alt="Dr. Processo" 
